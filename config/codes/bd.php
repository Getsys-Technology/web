...
public function select_items_2($campos,$tabla,$criterios = "")
{
    $conn = $this->conexion();
    $i = 0;
    $res = array();
...
{    
    ...
    $sql_log = "INSERT INTO `prueba`.`log`(`date`, `tabla`, `campo`, `tipo_trans`) VALUES ('".$fecha_h_m_s_2."', '".$tabla."', '".htmlspecialchars($sql,ENT_QUOTES)."', 'update')";
...
public function insert($tabla, $valores, $campos = "")
{
    ...
    $sql_log = "INSERT INTO `prueba`.`log`(`date`, `tabla`, `campo`, `tipo_trans`) VALUES ('".$fecha_h_m_s_2."', '".$tabla."', '".htmlspecialchars($sql,ENT_QUOTES)."', 'insert')";
    $insert = mysql_query($sql_log, $conn);
    if(!$insert)
        echo "Problemas al actualizar el log de transacción";
...
{   
    ...
    if($count != 0){
        ...
        $sql_log = "INSERT INTO `prueba`.`log`(`date`, `tabla`, `campo`, `tipo_trans`) VALUES ('".$fecha_h_m_s_2."', '".$tabla."', '".htmlspecialchars($sql,ENT_QUOTES)."', 'delete')";
