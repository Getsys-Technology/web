<?php 
    ...
    switch ($id_ciu){
        case 1: $from = "12001 and 13000";
                break;
        case 2: $from = "10001 and 11000";
                break;
        case 3: $from = "13001 and 14000";
                break;
        case 4: $from = "11001 and 12000";
                break;
    }
    $id = $bd->select_count("select max(id) from subcategoria where id between ".$from) + 1;
    cab($tit)    
?>
<script type='text/javascript' src='/local/admin/config/js/subcategorias/add.js'></script>

            <div id="div_gen_admin">
                <div id="div_tit">
                    SUBCATEGORIA NUEVA - <?php echo mayusculas($ciudad) ?>
                </div>
